...
namespace ReflectionRun
{
    ...
    {
        private static class MethodParmaValueFieldFactory
        {
            ...
            internal static void MethodParmaValueFieldInit()
            {
                ...
                all.AddRange(ReflectionRunCenter.GetStaticNoPublicMethodInfo(typeof(MethodParmaFieldPreciseTypeFactory)));
                ...
                all.AddRange(ReflectionRunCenter.GetStaticNoPublicMethodInfo(typeof(MethodParmaFieldBaseTypeFactory)));
                ...
                MethodInfo methodInfo, ParameterInfo info)
            {
                try
                {
                    var groupObj = methodInfo.Invoke(null, new[] { null, info ,(object)false});
            ...
            public static MethodParmaValueField GetValueFieldFromFactory(ParameterInfo info)
            {
                ...
                {
                    var view=new EnumMethodParmaValueField(info,false);
                    SetBorder(view);
                    return view;
                }
            ...
            internal static MethodParmaValueField GetErrorDefault(ParameterInfo info)
            {
                var field = new StringMethodParmaValueField(info,false);
